...
{
  module.controller('WithdrawCtrl', ['$scope', '$timeout', '$routeParams', 'rpId',
                                           ...
                                           keychain)
  {
    ...
    $scope.xrp = {
      name: xrpCurrency.to_human({full_name:$scope.currencies_all_keyed.ICC.name}),
    ...
    $scope.check_destination = function () {
      ...
      console.log("@@@@@@@@@:check_destination:", account);
    ...
    $scope.reset = function () {
      ...
      $scope.send = {
        recipient: '',
        recipient_name: '',
        recipient_address: Options.gateway.address,
        recipient_prev: '',
        recipient_info: {},
        amount: '',
