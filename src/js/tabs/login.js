...
//    });
    ...
    var updateFormFields = function(){
      ...
      // There are multiple login forms due to the iCloud URI login feature.
    ...
    function loginCallback (err, blob) {
      ...
      //login failed for a different reason
        ...
        if (err.name === "OldBlobError") {
          popup.confirm("Wallet Upgrade", "iCloud is upgrading the wallet encryption format. After the upgrade, only iCloud clients 0.2.24 or higher can access your wallet.<br><br>If you use other clients, please make sure they are upgraded to the current version.",
