 ...
 * NETWORK
 *
 * The network service is used to communicate with the iCloud network.
 *
...
function rpNetwork($scope, $timeout) {
   ...
   * iCloud network.
   *
   * Note that code in other places *is allowed* to call the iCloud
  ...
  var Network = function ()
  {
    ...
    // Set network max transaction fee from Options, or default to 12 drops of ICC
